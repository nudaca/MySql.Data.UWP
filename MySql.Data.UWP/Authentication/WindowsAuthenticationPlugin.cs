...
namespace MySql.Data.MySqlClient.Authentication
{
  ...
  internal class MySqlWindowsAuthenticationPlugin : MySqlAuthenticationPlugin
  {
    ...
    const int STANDARD_CONTEXT_ATTRIBUTES = 0;
        ...
        //[DllImport("secur32", CharSet = CharSet.Unicode, ExactSpelling = true)]
    ...
    //    [DllImport("secur32", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
    ...
    //    out SecPkgContext_Sizes pContextAttributes);
        ...
        //[DllImport("secur32.Dll", CharSet = CharSet.Unicode, SetLastError = false, ExactSpelling = true)]
